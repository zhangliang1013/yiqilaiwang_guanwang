	...
	<div>
		...
		<div class="w bg" style="margin-bottom: 64px;">
			<div class="contentaudit" >
				<div class="title" ref="span"><span >政策 • </span>{{newsDigest}}
				...
				<div class="u">
					...
					<!-- <span class="btn1" @click="editOne()">编辑</span> -->
				...
				<div class="line" v-if="content"></div>
				<!-- <h3>主图</h3>
				...
				<!-- <div class="acontent" v-html="content" ref="img"  v-clipboard:copy="$refs.span.innerText" v-clipboard:success="onCopy" v-clipboard:error="onError" > -->
				</div>
				...
				<div class="table file" v-if="fileCollection.length>0">
					<div class="mt">
						...
						<div class="option clear" @click="downloadAll()">
							...
							<p class="fl" style="color:#2168eb;">全部下载</p>
						</div>
					</div>
				...
				<div class="line" v-if="fileCollection.length>0"></div>

				<!--//活动审核按钮-->
				<div class="bens " v-if="isAudit">
					<div class="btn3 hand" v-on:click="back1()">编辑</div>
...
<script>
	...
	export default {
		...
		methods: {
			...
			downloadAll(){
				for(var index of this.fileCollection){
			...
			// 	console.log(this.$refs.img.innerText)
			// 	// alert(e.text)
			// },
			// onError: function (e) {
