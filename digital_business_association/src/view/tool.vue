	...
	<div class="w">
		...
		<div class="tool bg">
			<div class="content">
				...
				<router-link to="/editarticle?type=1" class="item" >
					<img src="../assets/img/glgj11@3x.png" alt="">
					<p>发资讯</p>
				</router-link>
				<router-link :to="{path: '/editarticle?type=2', query: {messageType:3}}" class="item" >
				...
				<router-link :to="{path: '/dcwj',}" class="item" >
					<img src="../assets/img/glgj12@3x.png" alt="">
					<p>发调查问卷</p>
				</router-link>
				...
				<!-- <router-link :to="{path: '/addHome'}" class="item" v-if="isOrg==5 || managerAuthList.indexOf(10)!=-1">
					<img src="../assets/img/hyzjj5@3x.png" alt="">
					<p>发会员之家</p>
				</router-link>
				<div  @click="routerTo(12)" class="item" v-if="(isOrg==5 || managerAuthList.indexOf(11)!=-1) ">
